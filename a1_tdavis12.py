[tdavis12@c7-tdavis12 ops435]$ cat a1_tdavis12.py 
#!/usr/bin/env python3
...
def after(UserDate, DesiredDays):
    ...
    ################ After ##################
   # This function will be called if the DesiredDay is greater or passed the UserDate that was given. It basically adds
    #the DesiredDay into the UserDate to come up with the answer.
...
def before(UserDate, DesiredDays):
    ...
    ############# BEFORE SECTION##########################################
  #  This function will be called if the user inputted a DesiredDay that is before the UserDate. It basically
   # subtracts the DesiredDay from the userDay to come up with the answer.
...
def usage():
  ...
  #  This function tells the user how to use the script. It displays a step by step guide
   # on what to put and how to put it.
